...
public class DBManager {
    ...
    public DBManager() throws SQLException {
        this.dbConn = DriverManager.getConnection("jdbc:sqlite:TicketLine/pt/isec/pd/ticketline/src/resources/db/PD-2022-23-TP.db");
        this.defaultDB = DriverManager.getConnection("jdbc:sqlite:TicketLine/pt/isec/pd/ticketline/src/resources/db/PD-2022-23-TP.db");
